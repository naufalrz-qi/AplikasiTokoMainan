...
public class ModelMainan {
    ...
    public ModelMainan(String nama_mainan, String merk, long harga, String satuan, int stok_mainan, String comp_nama_merk, int qty, String created_at, String update_at) {
